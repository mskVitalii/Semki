...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/user/reset_password/confirm": {
            "get": {
                ...
                "responses": {
                    "302": {
                        "description": "Redirects to /onboarding with accessToken and refreshToken",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "400": {
                        "description": "Bad request / invalid token / missing password",
                        "schema": {
                            "$ref": "#/definitions/lib.ErrorResponse"
                        }
                    },
